...
function translate($msgin){
    ...
    switch ($msgin) {
	case "About Calendarix": $new = "Acerca de Calendarix"; break ;		// translate?
	...
	case "events for whole calendar": $new = "Eventos del calendario entero"; break;
	...
	case "User group": $new = "Grupo del usuario"; break ;
