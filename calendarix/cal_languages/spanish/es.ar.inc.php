...
function translate($msgin){
	...
	case "Yes": $new = "Sí"; break;
        case "Display Settings": $new = "Seteos de Pantalla"; break;
	case "General Settings": $new = "Seteos Generales"; break;
	case "Text Settings": $new = "Seteos de Texto"; break;
	case "Holidays": $new = "Feriados"; break;
	case "Variable": $new = "Variable"; break;
	case "Day/Week/Listing View": $new = "Día/Semana/Listado"; break;
	case "Options": $new = "Opciones"; break;
	case "Value": $new = "Valor"; break;
	case "Row Listings": $new = "Listado de Filas"; break;
	case "Menus and Titles": $new = "Menues y Títulos"; break;
	case "Highlight Colors": $new = "Colores para Resaltar"; break;
	case "Title": $new = "Título"; break;
	case "Popup Settings": $new = "Seteo de Popups"; break;
	case "Allowed Views in User Calendar": $new = "Vistas permitidas en calendario de usuario"; break;
	case "Allowed search in User Calendar": $new = "Permitir búsqueda en usuario"; break;
	case "Display Areas": $new = "Mostrar Áreas"; break;
	case "Mail Configuration": $new = "Configuración de mail"; break;
	case "Using Stylesheet": $new = "Utilizando Stylesheet"; break;
        case "Date/Time Configuration": $new = "Día/Configuración Horaria"; break;
	case "Month View": $new = "Vista Mensual"; break;
	case "Page Body": $new = "Página"; break;
	case "Company Name": $new = "Nombre de la Compañia"; break;
	case "Month View Text": $new = "Texto de la vista mensual"; break;
	case "Calendar Name": $new = "Nombre del Calendario"; break;
	case "Popup Window Text": $new = "Texto de las ventanas Popus"; break;
	case "Other Text": $new = "Otro Texto"; break;
	case "Search Page Text": $new = "Texto de la página de búsqueda"; break;
	case "Footer Text": $new = "Texto del Pie"; break;
	case "Currency": $new = "Moneda"; break;
	case "style sheets will override these settings": $new = "Style sheet sobreescribirá los seteos"; break;
	case "Details": $new = "Detalles"; break;
	case "Delete": $new = "Borrar"; break;
	case "Edit": $new = "Editar"; break;
	case "repeat every year on": $new = "repetir cada año"; break;
	case "Notify": $new = "Notificar"; break;
	case "Account": $new = "Cuenta"; break;
	case "User List": $new = "Listado por Usuario"; break;
	case "Name": $new = "Nombre"; break;
	case "Once on": $new = "Una vez"; break;
	case "every": $new = "Todas"; break;
	case "event entry starts here": $new = "los eventos comienzan aquí"; break;
	case "Select users": $new = "Usuarios seleccionados"; break;
	case "Fee": $new = "Honorarios"; break;
        CASE "Refresh": $new = "Refrescar"; break;
        CASE "Edit information": $new = "Editar"; break;
        CASE "Change password": $new = "Cambiar contraseña"; break;
        CASE "Address": $new = "Dirección"; break;
        CASE "Email": $new = "Correo electrónico"; break;
        CASE "Role": $new = "Rol"; break;
        CASE "Functions": $new = "Función"; break;
        CASE "No.": $new = "Nro."; break;
        CASE "Website": $new = "sitio Web"; break;
        CASE "View events of user": $new = "Ver eventos de usuario"; break;
